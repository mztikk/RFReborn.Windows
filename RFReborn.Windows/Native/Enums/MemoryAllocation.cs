...
#pragma warning restore RCS1135 // Declare enum member with zero value (when enum has FlagsAttribute).
    {
        ...
        ///     To reserve and commit pages in one step, call <see cref="Kernel32.VirtualAllocEx" /> with MEM_COMMIT |
        ///     MEM_RESERVE.
        ...
        ///     You commit reserved pages by calling <see cref="Kernel32.VirtualAllocEx" /> again with MEM_COMMIT.
        ...
        ///     <see cref="Kernel32.VirtualAllocEx" /> returns an error if you use MEM_RESET and the range of memory is mapped to a
        ///     file.
        ...
        ///     When you specify MEM_RESET, the <see cref="Kernel32.VirtualAllocEx" /> function ignores the value of flProtect.
